...
from config import slicesPath, rawDataPath
...
from audioFilesTools import cleanFilenames

import argparse
parser = argparse.ArgumentParser()
parser.add_argument("mode", help="Trains or tests the CNN", nargs='+', choices=["clean","train","test","slice", "predict", "sliceInput"])
...
if "predict" in args.mode:
	...
	print json.dumps(genreCountDict)
	sys.stdout.flush()
